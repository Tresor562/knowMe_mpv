...
export const HERO_BLOCKOUT_REPORT_VERSION = 1 as const;
...
export const HERO_BLOCKOUT_BUDGETS=Object.freeze({minHeightMeters:1.35,maxHeightMeters:2.15,maxBodyTriangles:60000,maxBodyVertices:45000,maxTotalTriangles:75000});
...
export function validateHeroBlockoutReport(input:HeroBlockoutReport):HeroBlockoutReport{
 ...
 if(input.unitSystem!=='METERS'||input.runtimeUpAxis!=='Y'||input.pose!=='A_POSE'||input.centeredWorldOrigin!==true||input.groundContactY!==0)throw new Error('Hero blockout transform convention is invalid.');
