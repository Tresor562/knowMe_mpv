...
describe('Hero blockout source provenance gate',()=>{
  it('accepts a valid measured v7 report bound to source bytes',()=>expect(verifyHeroBlockoutSource(bytes,valid())).toBeDefined());
