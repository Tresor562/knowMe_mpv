...
export function PulseDuelExperience() {
  ...
  async function refresh() {
    ...
    setSessions(next.filter((session) => session.game.key === 'pulse-duel'));
    if (selected) {
  ...
  return (
    <View style={[styles.card, card]}>
      <Text style={[styles.title, { color: colors.text }]}>Pulse Duel</Text>
      <Text style={[styles.description, { color: colors.muted }]}>
        Duel gratuit et autoritaire : le serveur valide les tours, calcule le score et signe le replay.
      </Text>
